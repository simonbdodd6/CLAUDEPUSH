        ...
        : (
          <div className="space-y-2">
            {items.slice(0, 4).map((item, i) => (
              <div key={i} className="flex items-center gap-3 p-2.5 rounded-lg bg-surface-1 border border-border-subtle">
                ...
                <div className="flex gap-1.5 flex-shrink-0">
                  <Button variant="ghost" size="sm" className="text-xs text-danger hover:text-danger">Reject</Button>
                  <Button variant="primary" size="sm" className="text-xs">Approve</Button>
                </div>
              </div>
            ))}
          </div>
