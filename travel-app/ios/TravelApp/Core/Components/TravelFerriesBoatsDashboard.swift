    ...
    static var sampleIndonesia: FerryGuide {
        ...
        return FerryGuide(
            ...
            routes: [
                ...
                FerryConnection(from: "Bangsal", to: "Gili Air", region: "Gili", type: "Public boat", duration: "15–20 min", price: "Rp 20–40k", bookWindow: "At the port", safety: .sheltered, operatorName: "Public ferry (leaves when full)", note: "Cheapest option, but it departs only when full — don’t pair it with a same-day flight."),
